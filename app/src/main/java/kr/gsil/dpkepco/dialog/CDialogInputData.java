...
public class CDialogInputData extends Dialog {
    ...
    public CDialogInputData(@NonNull Context context) {
        // Dialog 배경을 투명 처리 해준다.
        super(context , android.R.style.Theme_Translucent_NoTitleBar);
        isNew = true;
    }

    public CDialogInputData(@NonNull Context context, boolean isNew, String title, String date, float data, String info
    ...
    public CDialogInputData(@NonNull Context context, boolean isNew, int titleId, String date, float data, int infoId
            , View.OnClickListener leftListener , View.OnClickListener centerListener , View.OnClickListener rightListener, int id) {
        super(context , android.R.style.Theme_Translucent_NoTitleBar);
        this.mLeftClickListener = leftListener;
        this.mCenterClickListener = centerListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cdialog_input_data);
    ...
    private void setData(float data){
        cdialog_et_data.setText(String.valueOf(data));
    ...
    private void setLayout(){
        cdialog_btn_del  = (Button)findViewById(R.id.cdialog_btn_del);
